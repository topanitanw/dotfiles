...
;;;;; basic coloring
   ...
   `(default ((t (:foreground ,zenburn-fg :background ,"#363636"))))
...
;;;;; font lock
   `(font-lock-builtin-face ((t (:foreground ,zenburn-blue-2 :weight bold))))
...
;;;;; linum-mode
   ;; `(linum ((t (:foreground ,zenburn-green+2 :background ,zenburn-bg :weight normal))))
   `(linum ((t (:inherit default :foreground ,zenburn-green-1))))
;;;;; ruler-mode
...
n     ((t (:foreground ,zenburn-yellow :slant italic :weight bold))) t)
   `(org-agenda-date-weekend
     ((t (:foreground ,zenburn-blue-1 :slant italic))) t)   
   ...
   `(org-level-1 ((t (:foreground ,zenburn-orange :weight bold))))
...
;;;;; web-mode
   ...
   `(web-mode-html-tag-face ((t (:foreground ,zenburn-yellow-2))))
